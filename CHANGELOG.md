...
### Changed
- `skills/commit-gpg/SKILL.md`: drop the `echo; echo '[press enter to close]'; read` tail from the `xterm -e` example so the terminal closes immediately after the commit completes.
...
[0.1.15]: https://github.com/MickaelBlet/CLAUDE_CODE_CONFIG/compare/v0.1.14...v0.1.15
